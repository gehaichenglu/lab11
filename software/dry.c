...
static char* myalloc(size_t size) {
  while (__umodsi3((unsigned long)free_mem , 4) != 0) free_mem ++;
  char *ret = free_mem;
  free_mem += size;
  return ret;
}
...
int * arr2 = (int*) Arr_2_Par_Ref;
  ...
  for (Int_Index = Int_Loc; Int_Index <= Int_Loc+1; ++Int_Index)
    //Arr_2_Par_Ref [Int_Loc] [Int_Index] = Int_Loc;
		arr2[ __mulsi3(Int_Loc, 50) + Int_Index] = Int_Loc;
  //Arr_2_Par_Ref [Int_Loc] [Int_Loc-1] += 1;
	arr2[ __mulsi3(Int_Loc, 50) + Int_Loc - 1] += 1;
	arr2[ __mulsi3(Int_Loc + 20, 50) + Int_Loc] = Arr_1_Par_Ref [Int_Loc];
 ...
 Number_Of_Runs = NUMBER_OF_RUNS;
  ...
  while (!Done) {
	...
	/* Bool_Glob == 1 */
      ...
      {
	Int_3_Loc =__mulsi3( 5 , Int_1_Loc) - Int_2_Loc;
	  /* Int_3_Loc == 7 */
	...
	/* Int_1_Loc == 3, Int_2_Loc == 3, Int_3_Loc == 7 */
      Int_2_Loc = __mulsi3(Int_2_Loc , Int_1_Loc);
      Int_1_Loc = __udivsi3(Int_2_Loc , Int_3_Loc);
      Int_2_Loc = __mulsi3(7 , (Int_2_Loc - Int_3_Loc)) - Int_1_Loc;
